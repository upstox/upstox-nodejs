...
describe('#UpstoxAPI', function () {
    ...
    describe('getLiveData()', function() {
        ...
        it('Should get the live data for required exchange and instruments successfully', function (done) {
            ...
            var start = function () {
                ...
                upstox.getLiveFeeds(params).then(function (response) {
                    console.log("Live Data ----------- Response ----------" + JSON.stringify(response.body, null, 2));
                    done();
                }).catch(function(response){
                    console.log("Live Data ------------ Error ----------" + JSON.stringify(response, null, 2));
                    done();
                });
            }
        });
        ...
        it('Should get the specified miniType details successfully', function (done) {
            ...
            upstox.getSessionToken(testdata.loginCred)
                .then(function (response) {
                    //console.log("Final Response ----------" + JSON.stringify(response.body, null, 2));
                    start();
                });
            ...
            var start = function () {
                ...
                upstox.getLiveFeeds(params).then(function (response) {
                    console.log("MiniType ------------ Response ----------" + JSON.stringify(response.body, null, 2));
                    done();
                }).catch(function(response){
                    console.log("LiveData ------------ Error ----------" + JSON.stringify(response.body, null, 2));
                    done();
                });
            }
        });
        ...
        it('Should place an order successfully', function (done) {
            ...
            var start = function() {
                upstox.placeOrder(testdata.orderObject).then(function (response) {
                    console.log("Order placement ------------ Response ----------" + JSON.stringify(response.body.data, null, 2));
        ...
        it('Should modify an order successfully', function (done) {
            ...
            var start = function () {
                upstox.modifyOrder(params).then(function (response) {
                    console.log("Modify orders ------------ Response ----------" + JSON.stringify(response.body, null, 2));
                    done();
                });
            }
        });
        ...
        it('Should delete an order successfully', function (done) {
            ...
            var start = function () {
                upstox.cancelOrder(params).then(function (response) {
                    console.log("Delete orders ------------ Response ----------" + JSON.stringify(response.body, null, 2));
                    done();
                });
            }
        });
