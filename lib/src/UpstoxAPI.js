 ...
 * @memberOf Upstox
 * @instance
 * @param {string} userId Upstox apiKey(username).
 */
...
Upstox.prototype.getLoginUri = function(redirect_uri, response_type){
    ...
    var __this = this;
    return urLDetails.host + urLDetails.path + "?apiKey=" + __this.auth.apiKey + "&redirect_uri=" + redirect_uri + "&response_type=" + response_type;
};
...
Upstox.prototype.getAccessToken = function(params) {
    ...
    logger.debug("apiKey" + __this.auth.apiKey);
    logger.debug("apiSecret" + params.apiSecret);
