...
These scripts place bearish options trades on Nifty 50 using the Upstox Node.js SDK. Use them when you think the market is going to go **down**.
...
## Buy Put — [code/buy_put.js](code/buy_put.js)
...
**Run:**
```bash
node code/buy_put.js
```

---

## Sell Call — [code/sell_call.js](code/sell_call.js)
...
**Run:**
```bash
node code/sell_call.js
```

---

## Bear Call Spread — [code/bear_call_spread.js](code/bear_call_spread.js)
...
**Run:**
```bash
node code/bear_call_spread.js
```

---

## Bear Put Spread — [code/bear_put_spread.js](code/bear_put_spread.js)
...
**Run:**
```bash
node code/bear_put_spread.js
```

---

## Bear Butterfly — [code/bear_butterfly.js](code/bear_butterfly.js)
...
**Run:**
```bash
node code/bear_butterfly.js
```

---

## Bear Condor — [code/bear_condor.js](code/bear_condor.js)
...
**Run:**
```bash
node code/bear_condor.js
```

---

## Long Calendar with Puts — [code/long_calendar_put.js](code/long_calendar_put.js)
...
**Run:**
```bash
node code/long_calendar_put.js
```

---

## Short Synthetic Future — [code/short_synthetic_future.js](code/short_synthetic_future.js)
...
**Run:**
```bash
node code/short_synthetic_future.js
```

---

## Put Ratio Back Spread — [code/put_ratio_back_spread.js](code/put_ratio_back_spread.js)
...
**Run:**
```bash
node code/put_ratio_back_spread.js
```

---

## Risk Reversal — [code/risk_reversal.js](code/risk_reversal.js)
