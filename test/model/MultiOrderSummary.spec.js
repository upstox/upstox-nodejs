...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MultiOrderSummary', function() {
      beforeEach(function() {
        instance = new UpstoxClient.MultiOrderSummary();
      });

      it('should create an instance of MultiOrderSummary', function() {
        // TODO: update the code to test MultiOrderSummary
        expect(instance).to.be.a(UpstoxClient.MultiOrderSummary);
      });
      ...
      it('should have the property payloadError (base name: "payload_error")', function() {
        // TODO: update the code to test the property payloadError
        expect(instance).to.have.property('payloadError');
        // expect(instance.payloadError).to.be(expectedValueLiteral);
      });
