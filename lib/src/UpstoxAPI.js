 ...
 */
Upstox.prototype.getLoginUri = function(redirect_uri, response_type){

    var urLDetails = utils.generateUrl('authorize', null);
    var __this = this;
    return urLDetails.host + urLDetails.path + "?client_id=" + __this.auth.client_id + "&redirect_uri=" + redirect_uri + "&response_type=" + response_type;
};
...
Upstox.prototype.getAccessToken = function(params) {
    ...
    logger.debug("client_id" + __this.auth.client_id);
    logger.debug("client_secret" + params.client_secret);
    var basicAuth = "Basic " + new Buffer(__this.auth.client_id + ':' + params.client_secret).toString('base64');
