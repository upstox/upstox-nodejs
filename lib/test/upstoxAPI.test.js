...
describe('#UpstoxAPI', function () {
    ...
    describe("getSessionToken()", function () {
        ...
        it('Should return a sessionToken after getting successfully logged in ', function (done) {
            ...
            upstox.getAccessToken(testdata.loginCred)
                .then(function () {
    ...
    describe.only('getProfile()', function() {
        ...
        it('Should return a users profile', function (done) {
            ...
            var loginUrl = upstox.getLoginUri("aicstooLib53HGWHwQY5o9FqXUONZzXF2SuUioA9", "http://localhost:3000" , "code");

            console.log(loginUrl);

           // var upstox = new Upstox();
            logger.debug(JSON.stringify(testdata.accessToken, null, 2));
            ...
            var start = function () {
                upstox.setToken("d9035a9916a6486f2eaf2bf3258997983941172b");
