...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CancelOrExitMultiOrderResponse', function() {
      beforeEach(function() {
        instance = new UpstoxClient.CancelOrExitMultiOrderResponse();
      });

      it('should create an instance of CancelOrExitMultiOrderResponse', function() {
        // TODO: update the code to test CancelOrExitMultiOrderResponse
        expect(instance).to.be.a(UpstoxClient.CancelOrExitMultiOrderResponse);
      });
