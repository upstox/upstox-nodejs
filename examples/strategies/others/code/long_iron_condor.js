...
// Step 1: Find the ATM+1 call (long call leg)
instrumentsApi.searchInstrument('Nifty 50', {
    ...
    // Step 2: Find the ATM-1 put (long put leg)
    instrumentsApi.searchInstrument('Nifty 50', {
        exchanges: 'NSE', segments: 'FO',
        ...
        // Step 3: Find the ATM+2 call (short call wing)
        instrumentsApi.searchInstrument('Nifty 50', {
            exchanges: 'NSE', segments: 'FO',
            ...
            console.log('Short call (ATM+2) - Trading symbol :', shortCall.tradingSymbol);

            // Step 4: Find the ATM-2 put (short put wing)
            instrumentsApi.searchInstrument('Nifty 50', {
                exchanges: 'NSE', segments: 'FO',
                ...
                console.log('Short put  (ATM-2) - Trading symbol :', shortPut.tradingSymbol);
                ...
                orderApi.placeOrder(body1, {}, (error, result1) => {
                    ...
                    orderApi.placeOrder(body2, {}, (error, result2) => {
                        ...
                        orderApi.placeOrder(body3, {}, (error, result3) => {
                            if (error) { console.error('API error:', error); return; }
                            console.log('Short call order placed successfully. Order ID:', result3);
                            ...
                            orderApi.placeOrder(body4, {}, (error, result4) => {
                                if (error) { console.error('API error:', error); return; }
                                console.log('Short put order placed successfully. Order ID:', result4);
                            });
                        });
                    });
                });
