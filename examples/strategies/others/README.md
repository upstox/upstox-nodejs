...
## Call Ratio Spread — [code/call_ratio_spread.js](code/call_ratio_spread.js)
...
**Run:**
```bash
node code/call_ratio_spread.js
```

---

## Put Ratio Spread — [code/put_ratio_spread.js](code/put_ratio_spread.js)
...
**Run:**
```bash
node code/put_ratio_spread.js
```

---

## Long Straddle — [code/long_straddle.js](code/long_straddle.js)
...
**Run:**
```bash
node code/long_straddle.js
```

---

## Long Strangle — [code/long_strangle.js](code/long_strangle.js)
...
**Run:**
```bash
node code/long_strangle.js
```

---

## Long Iron Butterfly — [code/long_iron_butterfly.js](code/long_iron_butterfly.js)
...
**Run:**
```bash
node code/long_iron_butterfly.js
```

---

## Long Iron Condor — [code/long_iron_condor.js](code/long_iron_condor.js)
...
**Run:**
```bash
node code/long_iron_condor.js
```

---

## Strip — [code/strip.js](code/strip.js)
...
## Strap — [code/strap.js](code/strap.js)
