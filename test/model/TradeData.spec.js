...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TradeData', function() {
      beforeEach(function() {
        instance = new UpstoxClient.TradeData();
      });

      it('should create an instance of TradeData', function() {
        // TODO: update the code to test TradeData
        expect(instance).to.be.a(UpstoxClient.TradeData);
      });
