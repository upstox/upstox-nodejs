...
function convertFeedCsvToJson(csvMessage) {
    ...
    tokens.forEach(function(t) {
        ...
        if(fields.length === 5) {
            ...
            // console.log("---fields.length ----------" + JSON.stringify(fields, null, 2));
            [obj.timestamp, obj.exchange, obj.symbol, obj.live_ltp, obj.live_open, obj.live_high, obj.live_low, obj.live_close, obj.live_yearly_high, obj.live_yearly_low] = fields;
        } else {
