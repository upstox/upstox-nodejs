 ...
 * @constructor
 * @name Upstox
 * @param {string} client_id Assigned to you used to authenticate the developers app
 * @param {string} [accessToken] SessionId generated after successfully logging to upstox API.
 * @example <caption>Initialize Upstox object</caption>
 * var Upstox = require("Upstox");
 * var up = new Upstox("your_apikey", "your_apiSecretKey");
 *
 */
function Upstox(client_id, accessToken) {

    /**
     * @type {{client_id: *, client_secret: *, accessToken: *}}
     * @memberOf Upstox
     */
    this.auth = {
        client_id: client_id,
 ...
 * @memberOf Upstox
 * @instance
 * @param {string} accessToken Token generated after the users logged in successfully with its Upstox client_id(username) and password.
 */
...
Upstox.prototype.setUserId = function(userId){
    var __this = this;
    __this.auth.accessToken.userId = userId;
};

/**
 * @method getLoginUri
 * @memberOf Upstox
 * @param client_id  Assigned to you used to authenticate the developers app
 * @param redirect_uri Redirect_uri specified by you while creating an app
 * @param response_type Th response_type should be "code"
 * @return {string} Login Url to get authorized.
 */
Upstox.prototype.getLoginUri = function(client_id, redirect_uri, response_type){

    var urLDetails = utils.generateUrl('authorize', null);
    return urLDetails.host + urLDetails.path + "?client_id=" + client_id + "&redirect_uri=" + redirect_uri + "&response_type=" + response_type;
};
 ...
 * @memberOf Upstox
 * @param {object} params
 * @param {string} params.client_id valid client id for UPSTOX
 * @param {string} params.client_secret
 * @param {string} params.code
 * @param {string} params.grantType
...
Upstox.prototype.getAccessToken = function(params) {
    ...
    var basicAuth = "Basic " + new Buffer(params.client_id + ':' + params.client_secret).toString('base64');
    logger.debug("Check baseAuth" + basicAuth);
    delete(params.client_id);
    delete(params.client_secret)

    return new promise(function (resolve, reject) {
        utils.restify("accessToken", HTTP_METHOD, params, null, {basicAuth: basicAuth})
            .then(function (response) {
                console.log("*****************", response);
                __this.setToken(response.accessToken);
...
Upstox.prototype.getProfile = function () {
    ...
    return utils.restify("profile", HTTP_METHOD, null, __this.auth.accessToken );
};
...
Upstox.prototype.getHoldings = function () {
    ...
    var __this = this;
    var HTTP_METHOD = "GET";
    return utils.restify("holdings", HTTP_METHOD, null, __this.auth.accessToken);
};
...
Upstox.prototype.getBalance = function () {
    ...
    var __this = this;
    var HTTP_METHOD = "GET";
    return utils.restify("balance", HTTP_METHOD, null, __this.auth.accessToken);
};
...
Upstox.prototype.getPositions = function () {
    ...
    var __this = this;
    var HTTP_METHOD = "GET";
    return utils.restify("positions", HTTP_METHOD, null, __this.auth.accessToken);
};
...
Upstox.prototype.placeOrder = function(params){
    ...
    var __this = this;
    var HTTP_METHOD = "POST";
    return utils.restify("placeOrder", HTTP_METHOD, params, __this.auth.accessToken);
};
...
Upstox.prototype.getOrders = function(){
    ...
    var __this = this;
    var HTTP_METHOD = "GET";
    return utils.restify("getOrders", HTTP_METHOD, null, __this.auth.accessToken)
};
...
Upstox.prototype.getTradesInfo = function(params){
    ...
    var __this = this;
    var HTTP_METHOD = "GET";
    return utils.restify("tradesInfo", HTTP_METHOD, params, __this.auth.accessToken)
};
...
Upstox.prototype.modifyOrder = function(params){
    ...
    return utils.restify("modifyOrder", HTTP_METHOD, params, __this.auth.accessToken)
};
...
Upstox.prototype.cancelOrder = function(params){
    ...
    return utils.restify("cancelOrder", HTTP_METHOD, params, __this.auth.accessToken)
};
...
Upstox.prototype.getMasterContract = function(params){
    ...
    return utils.restify("masterContract", HTTP_METHOD, params, __this.auth.accessToken)
...
Upstox.prototype.getLiveFeed = function(params){
    ...
    return utils.restify("liveFeed", HTTP_METHOD, params, __this.auth.accessToken);
};
...
Upstox.prototype.getOHLC = function(params){
    ...
    return utils.restify("OHLC", HTTP_METHOD, params, __this.auth.accessToken);
};
...
Upstox.prototype.subscribeFeed = function(params){
    ...
    return utils.restify("liveFeedSubscribe", HTTP_METHOD, params, __this.auth.accessToken)
}
...
Upstox.prototype.unsubscribeFeed = function(params){
    ...
    return utils.restify("liveFeedUnsubscribe", HTTP_METHOD, params, __this.auth.accessToken)
}
...
Upstox.prototype.connectSocket = function() {
    ...
    return new promise(function (resolve, reject) {
        if(__this.isAuthenticated) {
            ...
            logger.debug("In socket ---" + JSON.stringify(__this.auth.accessToken));
            socket.connect(utils.getSocketEndpoint(__this.auth.accessToken));
        } else {
