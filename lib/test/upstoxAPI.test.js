...
describe('#UpstoxAPI', function () {
        ...
        it('Should return positions', function (done) {
            ...
            var start = function() {
                upstox.getPositions().then(function (response) {
                    logger.debug("Position Response ----------" + JSON.stringify(response.body, null, 2));
                    done();
                });
            };
        });
    ...
    describe('getInstruments()', function() {
        ...
        it('Should get the specified exchange details successfully', function (done) {
            ...
            var start = function () {
                ...
                upstox.getInstruments(params).then(function (response) {
                    //logger.debug("BOD file  ------------ Response ----------" + JSON.stringify(response.body, null, 2));
                    done();
                }).catch(function(response){
                    done();
    ...
    describe('getLiveData()', function() {
        ...
        this.timeout(10000);
        it('Should get the live data for required exchange and instruments successfully', function (done) {
            var upstox = new Upstox("123");
            upstox.getSessionToken(testdata.loginCred)
                .then(function (response) {
                    //logger.debug("Final Response ----------" + JSON.stringify(response, null, 2));
            ...
            var start = function () {
                ...
                upstox.getLiveFeeds(testdata.defaultLiveData).then(function (response) {
                    logger.debug("Live Data ----------- Response ----------" + JSON.stringify(response.body, null, 2));
                    done();
                }).catch(function(response){
                    logger.error("Live Data ------------ Error ----------" + JSON.stringify(response, null, 2));
                    done();
                });
            }
        });

        it('Should get the specified miniType details successfully with mini', function (done) {
            var upstox = new Upstox("123");
            upstox.getSessionToken(testdata.loginCred)
                .then(function (response) {
            ...
            var start = function () {
                upstox.getLiveFeeds(testdata.miniLiveData).then(function (response) {
                    logger.debug("MiniType ------------ Response ----------" + JSON.stringify(response.body, null, 2));
                    done();
                }).catch(function(response){
                    logger.error("LiveData ------------ Error ----------" + JSON.stringify(response.body, null, 2));
                    done();
                });
            }
        });
        ...
        it('Should get the specified miniType details successfully with full', function (done) {
            ...
            var start = function () {
                upstox.getLiveFeeds(testdata.fullLiveData).then(function (response) {
                    logger.debug("MiniType ------------ Response ----------" + JSON.stringify(response.body, null, 2));
                    done();
                }).catch(function(response){
                    logger.error("LiveData ------------ Error ----------" + JSON.stringify(response.body, null, 2));
        ...
        it('Should get all order successfully', function (done) {
            ...
            var start = function () {
                upstox.getOrders().then(function (response) {
                    logger.debug("All orders ------------ Response ----------" + JSON.stringify(response.body, null, 2));
                    done();
                });
            }
        });
        ...
        it('Should place an order successfully', function (done) {
            ...
            var start = function() {
                upstox.placeOrder(testdata.orderObject).then(function (response) {
                    logger.debug("Order placement ------------ Response ----------" + JSON.stringify(response.body.data, null, 2));
    ...
    describe('modifyOrder()', function (){
        ...
        it('Should modify an order successfully', function (done) {
            ...
            var start = function () {
                upstox.modifyOrder(params).then(function (response) {
                    logger.debug("Modify orders ------------ Response ----------" + JSON.stringify(response.body, null, 2));
                    done();
                }, function(err) {
                    console.log(err);
                    done();
    ...
    describe('deleteOrder()', function (){
        ...
        it('Should delete an order successfully', function (done) {
            ...
            var start = function () {
                upstox.cancelOrder(params).then(function (response) {
                    logger.debug("Delete orders ------------ Response ----------" + JSON.stringify(response.body, null, 2));
                    done();
                });
            }
        });
    ...
    describe('getOrdersInfo()', function(){
        ...
        it('Should get specific order details', function (done) {
            ...
            var start = function() {
                upstox.placeOrder(testdata.orderObject).then(function (response) {
                    testdata.orderId = response.body.data.order_id;
                    upstox.getOrdersInfo({
                        orderIds: testdata.orderId
                    })
                    .then((response) => {
                        logger.debug("Orders Info ------------ Response ----------" + JSON.stringify(response.body.data, null, 2));
                        expect(response.code === 200);
                        should.exist(response.body.data);
                        var data = response.body.data;
    ...
    describe('getTradesInfo()', function(){
        ...
        it('Should gettrades for specific order id', function (done) {
            ...
            var start = function() {
                ...
                .then((response)=> {
                    logger.debug("Trades Info ------------ Response ----------" + JSON.stringify(response.body.data, null, 2));
                    expect(response.code === 200);
                    should.exist(response.body.data);
                    var data = response.body.data;
                    expect(data).to.be.instanceof(Array);
    ...
    describe('getOHLC()', function() {
        ...
        it('Should get ohlc successfully', function (done) {
            ...
            var start = function () {
                upstox.getOHLC(testdata.ohlc).then(function (response) {
    ...
    describe('on orderUpdate', function(){
        ...
        it('order update message should be received', (done)=>{
            ...
            var start = ()=>{
                ...
                upstox.placeOrder(testdata.orderObject).then(function (response) {
                    placedOrderData = response.body.data;
                    orderPlaced = true;
                    bothDone();
                });
            };
