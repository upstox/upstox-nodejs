...
/**
 * Get the orders book (all orders details)
 * @method getOrders
 * @instance
 * @memberOf Upstox
 * @return {res}
...
/**
 * Get the order details for specific order
 ...
 */
Upstox.prototype.getTradeBook = function(params){

    var __this = this;
    var HTTP_METHOD = "GET";
    return utils.restify("tradeBook", HTTP_METHOD, params, __this.auth)
};
