...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Depth', function() {
      beforeEach(function() {
        instance = new UpstoxClient.Depth();
      });

      it('should create an instance of Depth', function() {
        // TODO: update the code to test Depth
        expect(instance).to.be.a(UpstoxClient.Depth);
      });
