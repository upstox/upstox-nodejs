 ...
 * @param {object} params
 * @param {string} params.order_ids the order ids (comma separated) for which details are to be fetched
 * @memberOf Upstox
 * @return {res}
 * @example
{
...
Upstox.prototype.getOrdersInfo = function(params){
    ...
    var __this = this;
    var HTTP_METHOD = "GET";
    return utils.restify("getOrders", HTTP_METHOD, params, __this.auth)
};
