...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MarketStatusData', function() {
      beforeEach(function() {
        instance = new UpstoxClient.MarketStatusData();
      });

      it('should create an instance of MarketStatusData', function() {
        // TODO: update the code to test MarketStatusData
        expect(instance).to.be.a(UpstoxClient.MarketStatusData);
      });
