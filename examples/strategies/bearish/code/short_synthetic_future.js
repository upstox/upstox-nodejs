 ...
 * Sells an ATM call and buys an ATM put for the next weekly expiry.
 */
...
instrumentsApi.searchInstrument('Nifty 50', {
    ...
    console.log('Short call - Trading symbol :', shortCall.tradingSymbol);
    ...
    instrumentsApi.searchInstrument('Nifty 50', {
        ...
        console.log('Long put   - Trading symbol :', longPut.tradingSymbol);
