...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CancelOrderData', function() {
      beforeEach(function() {
        instance = new UpstoxClient.CancelOrderData();
      });

      it('should create an instance of CancelOrderData', function() {
        // TODO: update the code to test CancelOrderData
        expect(instance).to.be.a(UpstoxClient.CancelOrderData);
      });
