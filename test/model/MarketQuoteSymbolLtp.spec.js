...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MarketQuoteSymbolLtp', function() {
      beforeEach(function() {
        instance = new UpstoxClient.MarketQuoteSymbolLtp();
      });

      it('should create an instance of MarketQuoteSymbolLtp', function() {
        // TODO: update the code to test MarketQuoteSymbolLtp
        expect(instance).to.be.a(UpstoxClient.MarketQuoteSymbolLtp);
      });
