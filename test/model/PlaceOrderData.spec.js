...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PlaceOrderData', function() {
      beforeEach(function() {
        instance = new UpstoxClient.PlaceOrderData();
      });

      it('should create an instance of PlaceOrderData', function() {
        // TODO: update the code to test PlaceOrderData
        expect(instance).to.be.a(UpstoxClient.PlaceOrderData);
      });
