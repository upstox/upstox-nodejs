...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModifyOrderData', function() {
      beforeEach(function() {
        instance = new UpstoxClient.ModifyOrderData();
      });

      it('should create an instance of ModifyOrderData', function() {
        // TODO: update the code to test ModifyOrderData
        expect(instance).to.be.a(UpstoxClient.ModifyOrderData);
      });
