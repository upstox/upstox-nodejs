...
function convertFeedCsvToJson(csvMessage) {
    ...
    tokens.forEach(function(t) {
        ...
        if(fields.length === 5) {
            ...
            [obj.timestamp, obj.exchange, obj.symbol, obj.ltp, obj.open, obj.high, obj.low, obj.close, obj.vtt, obj.atp, obj.oi, obj.spot_price, obj.total_buy_qty, obj.total_sell_qty, obj.lower_circuit, obj.higher_circuit, obj.yearly_low, obj.yearly_high] = fields;
            obj.bids = [];
            obj.asks = [];
