...
These scripts place neutral options trades on Nifty 50 using the Upstox Node.js SDK. Use them when you think the market is going to **stay in a range** — not move up or down significantly.
...
## Short Straddle — [code/short_straddle.js](code/short_straddle.js)
...
**Run:**
```bash
node code/short_straddle.js
```

---

## Short Strangle — [code/short_strangle.js](code/short_strangle.js)
...
**Run:**
```bash
node code/short_strangle.js
```

---

## Iron Butterfly — [code/iron_butterfly.js](code/iron_butterfly.js)
...
**Run:**
```bash
node code/iron_butterfly.js
```

---

## Batman — [code/batman.js](code/batman.js)
...
## Short Iron Condor — [code/short_iron_condor.js](code/short_iron_condor.js)
...
**Run:**
```bash
node code/short_iron_condor.js
```
