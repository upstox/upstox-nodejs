        ...
        it('Should unauthorized, wrong credentials ', function (done) {
            ...
            upstox.getSessionToken(cred)
                ...
                .catch(function(response){
                    //logger.debug("********* getSessionToken  401  ********** \n" + JSON.stringify(error, null, 2));
    ...
    describe('getLiveData()', function() {
        ...
        it('Should get the live data for required exchange and instruments successfully', function (done) {
            ...
            var start = function () {
                ...
                upstox.getLiveFeeds(params).then(function (response) {
                    logger.debug("Live Data ----------- Response ----------" + JSON.stringify(response.body, null, 2));
                    done();
                }).catch(function(response){
                    logger.debug("Live Data ------------ Error ----------" + JSON.stringify(response, null, 2));
                    done();
                });
            }
        });

        it('Should get the specified miniType details successfully', function (done) {
            var upstox = new Upstox("123");
            upstox.getSessionToken(testdata.loginCred)
                .then(function (response) {
            ...
            var start = function () {
                ...
                upstox.getLiveFeeds(params).then(function (response) {
                    ...
                    logger.debug("LiveData ------------ Error ----------" + JSON.stringify(response.body, null, 2));
                    done();
                });
            }
        });
