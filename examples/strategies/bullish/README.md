...
These scripts place bullish options trades on Nifty 50 using the Upstox Node.js SDK. Use them when you think the market is going to go **up**.
...
## Buy Call — [code/buy_call.js](code/buy_call.js)
...
**Run:**
```bash
node code/buy_call.js
```

---

## Sell Put — [code/sell_put.js](code/sell_put.js)
...
**Run:**
```bash
node code/sell_put.js
```

---

## Bull Call Spread — [code/bull_call_spread.js](code/bull_call_spread.js)
...
**Run:**
```bash
node code/bull_call_spread.js
```

---

## Bull Put Spread — [code/bull_put_spread.js](code/bull_put_spread.js)
...
**Run:**
```bash
node code/bull_put_spread.js
```

---

## Bull Butterfly — [code/bull_butterfly.js](code/bull_butterfly.js)
...
**Run:**
```bash
node code/bull_butterfly.js
```

---

## Bull Condor — [code/bull_condor.js](code/bull_condor.js)
...
**Run:**
```bash
node code/bull_condor.js
```

---

## Long Calendar with Calls — [code/long_calendar_call.js](code/long_calendar_call.js)
...
**Run:**
```bash
node code/long_calendar_call.js
```

---

## Long Synthetic Future — [code/long_synthetic_future.js](code/long_synthetic_future.js)
...
**Run:**
```bash
node code/long_synthetic_future.js
```

---

## Call Ratio Back Spread — [code/call_ratio_back_spread.js](code/call_ratio_back_spread.js)
...
**Run:**
```bash
node code/call_ratio_back_spread.js
```

---

## Range Forward — [code/range_forward.js](code/range_forward.js)
